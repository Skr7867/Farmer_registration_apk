...
class AuthController extends GetxController {
  ...
  void register() async {
    ...
    try {
      var response = await dioInstance
          .post("https://sowlab.com/assignment/user/register", data: map);
  ...
  void login() async {
    ...
    try {
      var response = await dioInstance
          .post("https://sowlab.com/assignment/user/login", data: map);
      print(response.data);
      if (response.data != null) {
        Get.rawSnackbar(message: response.data["message"]);
      }
  ...
  void verifyOtp() async {
    ...
    try {
      var response = await dioInstance
          .post("https://sowlab.com/assignment/user/verify-otp", data: map);
      print(response.data);
      if (response.data != null) {
        Get.rawSnackbar(message: response.data["message"]);
      }
  ...
  void resetPassword(String token) async {
    ...
    try {
      var response = await dioInstance
          .post("https://sowlab.com/assignment/user/reset-password", data: map);
      print(response.data);
      if (response.data != null) {
        Get.rawSnackbar(message: response.data["message"]);
      }
